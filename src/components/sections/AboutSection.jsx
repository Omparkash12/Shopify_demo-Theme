    ...
    return (
        <section className="aboutSection bg-[#F8EDE3] float-left w-[100%]">
            <div className="container_fluid_ar">
                <div className="about_data flex sm:flex-row flex-col items-center gap-[2%] sm:px-[0] px-[24px] md:py-[3rem] py-[2rem]">
                    ...
                    <div className="left_data sm:w-[50%] w-[100%]">
                        ...
                        <a href="/#" className='flex items-center font-[Nexa] sm:text-[16px] text-[12px] sm:leading-[20px] leading-[16px] uppercase '>Know More
