            ...
            <Disclosure>
                <section className='footer_brand_ar'>
                    <div className="footer_brand_data text-[#B8DFE7]">
                        <Disclosure.Button className="Footer_brand_image md:cursor-default">
                        ...
                        {/* <Disclosure>
                            <Disclosure.Button>Find out what lies beneath</Disclosure.Button>
                            <Disclosure.Panel>Here I am! I am the buried treasure!</Disclosure.Panel>
                        </Disclosure> */}
                    </div>
                </section>
